...
public class ProtokollitajaRestController {
	...
	public @ResponseBody String saveCompetition(@RequestBody Competition competition, HttpServletResponse response) {
	...
	public @ResponseBody String updateCompetition(@RequestBody Competition competition, HttpServletResponse response) {
